...
/datum/ai_holder
	...
	var/breakthrough_max = 30				// How many times we'll try to smash something to get to our destination before giving up.
	var/break_attempts = 0					// How many we've already tried.
